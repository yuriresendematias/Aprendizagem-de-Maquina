...
c.addLegend(420, 100, 1, "Times New Roman Bold", 12).setBackground(0xd0d0d0, 0xd0d0d0, 1)
...
layer.setAggregateLabelStyle("Times New Roman Bold Italic", 10).setBackground(0xffcc66, Transparent,
    1)
